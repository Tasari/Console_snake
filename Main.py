...
while 1:
    ...
    score, speed, drunk_fruit_flag, boring_fruit_flag, drunk_counter, boring_counter = player.move(direction, score, speed,drunk_fruit_flag, boring_fruit_flag, drunk_counter, boring_counter)
